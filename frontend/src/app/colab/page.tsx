        ...
        try {
            const response = await apiFetch("/execute/python", {
                ...
                body: JSON.stringify({
                    ...
                    cell_order: index,
                    mind_id: mindId,
                    auto_learn: autoLearn // Pass the toggle state
                })
            });

            const data = await response.json();

            // Handle ephemeral claims if auto-learn is off
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            <h1 style={{ marginBottom: '2rem', fontSize: '2rem', fontWeight: 700 }}>
                ...
                <span style={{ fontSize: '0.9rem', color: '#666', fontWeight: 400, marginLeft: '1rem', display: 'block', marginTop: '0.5rem' }}>
                    Shortcut: Press <b>Cmd+Enter</b> to run, or <b>Shift+Enter</b> to run and add new cell.
                </span>
            </h1>
